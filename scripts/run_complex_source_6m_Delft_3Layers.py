...
path_conf = '/home/edwinobando/PINN/01_AI_Geophysics_Inversion/MODELS_2D_Reconstructed/COMPLEX_VERSION_02/config/'

@physicsnemo.sym.main(config_path=path_conf, config_name="config_FNO_complex")
def run(cfg: PhysicsNeMoConfig) -> None:
    ...
    train_path = to_absolute_path(
        "/home/edwinobando/PINN/01_AI_Geophysics_Inversion/database/hdf5_files/dataset_source_6m_train_Delft_3Layers.hdf5"
    )
    test_path = to_absolute_path(
        "/home/edwinobando/PINN/01_AI_Geophysics_Inversion/database/hdf5_files/dataset_source_6m_test_Delft_3Layers.hdf5"
    )
    # [keys]
    ...
    train_dataset = HDF5GridDataset(
        train_path, invar_keys=["X"], outvar_keys=["Y"], n_examples=4000
    )
    test_dataset = HDF5GridDataset(
        test_path, invar_keys=["X"], outvar_keys=["Y"], n_examples=1000
    )
    # [datasets]
