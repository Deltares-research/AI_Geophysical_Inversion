...
def run(cfg: PhysicsNeMoConfig) -> None:
    ...
    train_path = to_absolute_path(
        "/home/edwinobando/PINN/01_AI_Geophysics_Inversion/database/hdf5_files/dataset_CASE_II_source_31m_train.hdf5"
    )
    test_path = to_absolute_path(
        "/home/edwinobando/PINN/01_AI_Geophysics_Inversion/database/hdf5_files/dataset_CASE_II_source_31m_test.hdf5"
    )
    # [keys]
